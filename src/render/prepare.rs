        ...
        match height.clone() {
            WarblerHeight::Uniform(height) => {
                ...
                let bind_group = render_device.create_bind_group(
                    Some("grass blade height bind group"),
                    &layout,
                    &[BindGroupEntry {
                        binding: 0,
            ...
            WarblerHeight::Texture(heights_texture) => {
                ...
                let bind_group = render_device.create_bind_group(
                    Some("grass height map bind group"),
                    &layout,
                    &[BindGroupEntry {
                        binding: 0,
...
pub(crate) fn prepare_normal_map_buffer(
    ...
    for (entity, normal_map) in inserted_grass.iter() {
        ...
        let bind_group = render_device.create_bind_group(
            Some("grass normal-map bind group"),
            &layout,
            &[BindGroupEntry {
                binding: 0,
