...
use warbler_grass::{prelude::*, bundle::WarblersBundle, density_map::DensityMap, height_map::HeightMap};
mod helper;
fn main() {
    App::new()
...
fn setup_grass_chunks(mut commands: Commands, asset_server: Res<AssetServer>) {
    ...
    for chunk in 0..400 {
        let offset = Vec3::new((chunk / chunk_width) as f32 * chunk_width as f32 * 1.05, 0., (chunk % chunk_width) as f32 * chunk_height as f32 * 1.05);
        commands.spawn(WarblersBundle {
            density_map: density_map.clone(),
            height_map: height_map.clone(),
            aabb: Aabb::from_min_max(Vec3::ZERO, Vec3::new(chunk_width as f32, 2., chunk_height as f32)),
